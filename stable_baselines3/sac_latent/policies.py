...
class SACPolicyLatent(BasePolicy):
    """
    ...
    def make_actor(self, features_extractor: Optional[BaseFeaturesExtractor] = None) -> ActorLatent:
        actor_kwargs = self._update_features_extractor(self.actor_kwargs, features_extractor)
        return ActorLatent(**actor_kwargs).to(self.device)
